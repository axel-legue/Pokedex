package com.axell.pokedex.core.functional

/**
 * @see [link](https://github.com/android10/Android-CleanArchitecture-Kotlin/blob/main/app/src/main/kotlin/com/fernandocejas/sample/core/functional/Either.kt)
